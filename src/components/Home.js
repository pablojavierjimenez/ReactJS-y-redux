  ...
  render() {
    return (
      <main className="App">
         ...
         * the _.bind(this)_
         */}
        <button className="botonLoco" onClick={this.onMakeOlder.bind(this)}>
          Make me Older!
        </button>
        {/**
         * **Case 2**
         ...
         */}
        <button className="botonLoco" onClick={() => this.resetAge()}>
          Reset Age
        </button>
        {/**
         * **Case 3**
         * the _arrow function_ one
         */}
        <button className="botonLoco" onClick={this.onMakeYounger}>
          Make me Younger!
        </button>
      </main>
    );
